...
# ----------------------------------------
# If pll_control is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 720 win32 2023.11.18.21:47:21
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_control"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_control.vho"
}
